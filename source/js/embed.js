//Only suitable for MariCat:Dreamlanf http://lotors.me/ 
//移动客户端判断开始
...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 3731202) {
        if (checkMobile()) {
            ssk = '<span class="ua"><span class="sskadmin">喵星人</span></span><br><br>';
        } else {
            ssk = '<span class="ua"><span class="sskadmin">喵星人</span></span>';
        }
    } else {
        if (checkMobile()) {
            ssk = '<br><br>';
